...
import { MenuPlacement, MenuPosition, CommonProps, Theme, GroupBase, CommonPropsAndClassName, CoercedMenuPlacement, CSSObjectWithLabel } from 'react-select/dist/declarations/src/types';
interface MenuState {
...
export declare class MenuPlacer<Option, IsMulti extends boolean, Group extends GroupBase<Option>> extends Component<MenuPlacerProps<Option, IsMulti, Group>, MenuState> {
    ...
    getUpdatedProps: () => {
        ...
        clearValue: () => void;
        cx: import("react-select/dist/declarations/src/types").CX;
        getStyles: import("react-select/dist/declarations/src/types").GetStyles<Option, IsMulti, Group>;
        getValue: () => import("react-select/dist/declarations/src/types").Options<Option>;
        hasValue: boolean;
        isMulti: boolean;
        isRtl: boolean;
        options: import("react-select/dist/declarations/src/types").OptionsOrGroups<Option, Group>;
        selectOption: (newValue: Option) => void;
        selectProps: import("react-select/dist/declarations/src/Select").Props<Option, IsMulti, Group>;
        setValue: (newValue: import("react-select/dist/declarations/src/types").OnChangeValue<Option, IsMulti>, action: import("react-select/dist/declarations/src/types").SetValueAction, option?: Option | undefined) => void;
        theme: Theme;
        minMenuHeight: number;
        maxMenuHeight: number;
        menuPlacement: MenuPlacement;
